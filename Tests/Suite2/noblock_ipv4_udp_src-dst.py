...
#       are configured that should not be blocked by the IPS.
#
# Usage: python noblock_ipv4_udp_src-dst.py
#
...
#
# Note:
#   - Test output can be found in noblock_ipv4_udp_src-dst_results.log
#
...
NUM_ATTEMPTS = 3
PORT_NUM_DST = [30,31,32,33,90,223,9080]
