...
#
# Test: Send ICMPv6 echo requests from h3 to h4 that should not be
#       blocked by the IPS.
#
# Usage: python noblock_ipv6_icmpv6.py
#
...
#
# Note:
#   - Test output can be found in noblock_ipv6_icmpv6_results.log
#
