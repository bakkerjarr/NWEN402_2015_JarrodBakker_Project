...
#
# Test: Send ICMP echo requests from h3 to h4 that should be blocked
#       by the IPS.
#
# Usage: python block_ipv4_icmp.py
#
...
#
# Note:
#   - Test output can be found in block_ipv4_icmp_results.log
#
